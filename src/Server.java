...
public class Server implements Runnable {
     ...
     */
     ...
     {   int accIndex;             	/* Index position of account to update */
         ...
         /* Process until the client is disconnected and the input buffer is empty */
         ...
         { 
             ...
             if (objNetwork.getInBufferStatus().equals("empty") && objNetwork.getClientConnectionStatus().equals("disconnected")) {
                 break;
             }
