...
public class Network implements Runnable {
    ...
    while (!(getClientConnectionStatus().equals("disconnected")
            ...
            && getInBufferStatus().equals("empty")
            && getOutBufferStatus().equals("empty")))
    {
            Thread.yield();
    }

    	/* Print termination log matching previous behavior */
    	System.out.println("\n Terminating network thread -  " +
    	        "Client " + getClientConnectionStatus() + " Server " + getServerConnectionStatus());
    }
}
