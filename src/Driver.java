...
public class Driver {
    ...
    continuously consume CPU cycles while waiting, repeatedly polling the status of the task. Yield allows waiting threads to give up the CPU, reducing wasted
